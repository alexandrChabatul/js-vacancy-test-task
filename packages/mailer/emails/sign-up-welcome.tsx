...
export const SignUpWelcome: FC<SignUpWelcomeProps> = ({
  ...
  <Layout previewText="Welcome on board the Shopy!">
    ...
    <Text>
      Your account has been successfully verified, and you are now a part of a vibrant network of
      people who share your interest in our digital services. We are confident that our platform
      will offer you the tools, resources, and connections you need to succeed.
    </Text>
